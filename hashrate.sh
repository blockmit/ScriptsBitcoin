...
hactual=$($raiz getblockhash $antbloque)#!/bin/bash
...
echo "------------------------------------------------------------"
echo ""
echo " Bloque actual: $bloque"
echo " Hashrate EPOCH actual: $hashdif" EH/s
echo ""
echo "------------------------------------------------------------"
echo ""
echo " Quedan $((2016 - $resta)) bloques para cambio de dificultad."
echo ""
echo " Hashrate ultimas 24 horas: $hashrate" EH/s
echo ""
echo " Hashrate en este EPOCH: $hashratefin" EH/s
echo ""
echo " Cambio futura dificultad: $cambiodif""%"
echo ""
echo "------------------------------------------------------------"
buscar=$($raiz getblock $hactual | grep \"time | tr -d , | cut -d" " -f4)
